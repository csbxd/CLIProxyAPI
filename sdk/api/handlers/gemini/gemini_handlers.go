...
func (h *GeminiAPIHandler) GeminiModels(c *web.Context) {
	rawModels := h.Models()
...
func (h *GeminiAPIHandler) GeminiGetHandler(c *web.Context) {
	var request struct {
...
func (h *GeminiAPIHandler) GeminiHandler(c *web.Context) {
	var request struct {
		Action string `uri:"action" binding:"required"`
	}
	if err := c.ShouldBindUri(&request); err != nil {
...
func (h *GeminiAPIHandler) handleStreamGenerateContent(c *web.Context, modelName string, rawJSON []byte) {
	alt := h.GetAlt(c)
...
func (h *GeminiAPIHandler) handleCountTokens(c *web.Context, modelName string, rawJSON []byte) {
...
func (h *GeminiAPIHandler) handleGenerateContent(c *web.Context, modelName string, rawJSON []byte) {
	c.Header("Content-Type", "application/json")
	alt := h.GetAlt(c)
	cliCtx, cliCancel := h.GetContextWithCancel(h, c, context.Background())
...
func (h *GeminiAPIHandler) forwardGeminiStream(c *web.Context, flusher http.Flusher, alt string, cancel func(error), data <-chan []byte, errs <-chan *interfaces.ErrorMessage) {
